...
const combo = {
  ...
  price: 79000,
  image:
    'https://thumbs.dreamstime.com/b/singapore-january-tgv-cinema-hollywood-popcorn-p-pepsi-background-80518601.jpg',
};

export default function ComboItem() {
  const [quantity, setQuantity] = useState(0);
  const router = useRouter();
  const setComboItems = useBookingStore(state => state.setComboItems);

  const handleNext = () => {
    setComboItems([{ name: 'Popcorn', quantity: 1 }]);
    router.push('/buy-ticket/payment');
  };
